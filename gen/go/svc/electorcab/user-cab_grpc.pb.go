...
const (
	UserService_CreateCabinet_FullMethodName            = "/elector.UserService/CreateCabinet"
...
func _UserService_CreateCabinet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServiceServer).CreateCabinet(ctx, in)
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UserService_CreateCabinet_Handler,
		},
		{
	...
	Metadata: "svc/electorcab/user-cab.proto",
}
